...
const Homepage = () => {
  return (
    <div className="mx-auto md:mx-40 my-20">
      <div className="flex justify-center items-center text-center flex-col md:flex-row md:text-left">
        ...
        <div className="my-5 mx-10">
          ...
          <div className="text-xl md:max-w-max bg-blue-700 p-5 my-5 rounded-md border-2 border-blue-700 cursor-default font-semibold transition hover:bg-white bold">
            Scale Your Business
          </div>
        </div>
      </div>
